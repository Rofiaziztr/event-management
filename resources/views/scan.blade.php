                ...
                <div class="p-6">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-0 pointer-events-none" id="scanner-overlay">
                            ...
                            <div class="absolute top-4 left-4 w-6 h-6 border-l-4 border-t-4 border-blue-400 rounded-tl-lg"></div>
                            <div class="absolute top-4 right-4 w-6 h-6 border-r-4 border-t-4 border-blue-400 rounded-tr-lg"></div>
                            <div class="absolute bottom-4 left-4 w-6 h-6 border-l-4 border-b-4 border-blue-400 rounded-bl-lg"></div>
                            <div class="absolute bottom-4 right-4 w-6 h-6 border-r-4 border-b-4 border-blue-400 rounded-br-lg"></div>
                        </div>
                    </div>
                    
                    <!-- Results Area -->
                    <div id="qr-reader-results" class="mt-6 text-center min-h-[60px] flex items-center justify-center">
