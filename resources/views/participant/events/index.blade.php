                ...
                <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl p-6 text-white shadow-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ ($events->total() ?? 0) - count($attendedEventIds ?? []) }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ $events->where('status', 'Berlangsung')->count() ?? 0 }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($events as $event)
                    <a href="{{ route('participant.events.show', $event) }}" class="block">
                        <div
                            class="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden flex flex-col relative group transition-all duration-300 hover:shadow-xl">
