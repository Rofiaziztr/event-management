                    ...
                    <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white shadow-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-emerald-100 text-sm">Check-in pada:
                                    {{ \Carbon\Carbon::parse($attendance->check_in_time)->format('d M Y, H:i') }} WIB
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-2xl p-6 text-white shadow-lg">
                        <div class="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                            ...
                            <a href="{{ route('scan.index') }}"
                                class="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 bg-white text-yellow-600 font-bold rounded-lg shadow-md hover:bg-yellow-50 transition-colors duration-200">
