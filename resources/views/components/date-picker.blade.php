...
<div class="relative">
    <input type="text" name="{{ $name }}" id="{{ $id }}" value="{{ $value }}"
        class="flatpickr py-3 px-4 block w-full border-gray-300 rounded-lg text-sm focus:border-yellow-500 focus:ring-yellow-500 disabled:opacity-50 disabled:pointer-events-none"
