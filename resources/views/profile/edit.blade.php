        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white shadow rounded-xl border overflow-hidden">
                        <div class="p-6 ">
                            <div class="flex flex-col items-center mb-4">
                                <div
                                    class="w-24 h-24 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center text-white text-3xl font-bold shadow-lg float mb-4">
                                    {{ substr(Auth::user()->full_name ?? Auth::user()->name, 0, 1) }}
                                </div>
                                <h2 class="font-semibold text-lg text-center">
                                    {{ Auth::user()->full_name ?? Auth::user()->name }}</h2>
                                ...
                                <dl class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">
                                            {{ Auth::user()->created_at->format('d M Y') }}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                ...
                <div class="md:col-span-2 space-y-6">
                    <!-- Profile Information -->
                    <div class="bg-white shadow rounded-xl border border-yellow-100 overflow-hidden scale-hover"
                        x-data="fadeIn(100)">
                        <div class="p-6">
                    ...
                    <!-- Delete Account -->
                    <div class="bg-white shadow rounded-xl border border-red-100 overflow-hidden scale-hover"
                        x-data="fadeIn(300)">
                        <div class="p-6">
