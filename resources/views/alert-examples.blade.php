            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="mb-4 text-sm text-gray-600">Alert ini dikirim dari controller dan akan muncul setelah redirect.</p>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg" x-data="alertDemo()">
                        ...
                        <p class="mb-4 text-sm text-gray-600">Alert ini langsung dipicu oleh JavaScript tanpa reload halaman.</p>
