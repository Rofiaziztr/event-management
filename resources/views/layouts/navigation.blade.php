<nav class="bg-white border-b shadow-sm sticky top-0 z-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            {{-- Left: Hamburger button to toggle mobile sidebar (Mobile only) --}}
            ...
            {{-- Right: Profile Button (Desktop + Mobile) --}}
            <div class="flex items-center" x-data="{ open: false }">
                <div class="relative">
                    <button @click="open = !open" @click.away="open = false"
                        class="inline-flex items-center justify-center px-3 py-2 rounded-md text-gray-400 hover:text-yellow-600 hover:bg-yellow-50 focus:outline-none transition-all duration-200"
