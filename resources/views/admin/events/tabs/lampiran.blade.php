                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs md:text-sm text-gray-500 mt-1">Dokumen, foto, atau video pendukung acara.
                            </p>
                        </div>
                    </div>
                    <span
                        class="mt-2 sm:mt-0 bg-blue-100 text-blue-800 text-xs font-medium px-3 py-1 rounded-full shadow-sm">
            ...
            <div class="divide-y divide-gray-100">
                            ...
                            <div class="flex items-start space-x-4 flex-1 min-w-0">
                                ...
                                <div class="flex-shrink-0">
                                    @php
                                        ...
                                        $iconClass =
                                            'w-8 h-8 rounded-lg flex items-center justify-center text-white text-xs font-semibold shadow-sm';
                                        $fileIcons = [
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-xs sm:text-sm font-semibold text-gray-900 truncate"
                ...
                @empty
                    <div class="p-6 text-center">
                        ...
                        <p class="text-gray-500 text-sm sm:text-xs mb-1.5">Belum ada lampiran yang diunggah</p>
                        <p class="text-gray-400 text-sm sm:text-xs">Gunakan form di sebelah kanan untuk menambahkan lampiran.</p>
                    </div>
                @endforelse
            </div>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-end pt-3">
                        <x-bladewind::button can_submit="true" color="indigo" icon="cloud-upload" has_spinner="true"
                            class="text-sm shadow-md hover:shadow-lg transition-shadow duration-200">
                            Unggah File
                        </x-bladewind::button>
                    </div>
                </div>
