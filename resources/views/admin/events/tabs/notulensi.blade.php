    ...
    <div class="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-yellow-200 content-transition">
                ...
                <div
                    ...
                    @if ($lastUpdated)
                        <div class="text-right bg-yellow-50 px-3 py-2 rounded-lg border border-yellow-100">
                            ...
                            <p class="text-gray-900 text-sm font-medium">{{ $lastUpdated->format('d M Y, H:i') }} WIB
                            </p>
                        </div>
                    @endif
                </div>
            ...
            <form action="{{ route('admin.events.notulensi.store', $event) }}" method="POST" class="p-6">
                ...
                <div
                    class="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-gray-300 rounded-lg overflow-hidden">
                        <div class="bg-gray-100 border-b border-gray-300 p-2 flex items-center gap-1 rounded-t-lg overflow-x-auto whitespace-nowrap"
                            ...
                            <div class="flex items-center border-r border-gray-300 pr-2 mr-2">
                                <button type="button" onclick="formatText('bold')" title="Bold"
                                    ...
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M5 4v3h5.5a2 2 0 110 4H5v3h5.5a3.5 3.5 0 100-7H5z"
                                            clip-rule="evenodd" />
                                    </svg>
                                </button>
                                <button type="button" onclick="formatText('italic')" title="Italic"
                                    ...
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M8 2a1 1 0 000 2h2.071l-4.286 12H4a1 1 0 100 2h8a1 1 0 100-2H9.929l4.286-12H16a1 1 0 100-2H8z"
                                            clip-rule="evenodd" />
                                    </svg>
                                </button>
                                <button type="button" onclick="formatText('underline')" title="Underline"
                                    ...
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M4 18a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM5 6a5 5 0 1110 0v4a1 1 0 11-2 0V6a3 3 0 10-6 0v4a1 1 0 11-2 0V6z"
                                            clip-rule="evenodd" />
                                    </svg>
                                </button>
                            </div>
                            ...
                            <div class="flex items-center border-r border-gray-300 pr-2 mr-2">
                                <button type="button" onclick="formatText('insertOrderedList')"
                                    ...
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M7 4h14v2H7V4zm0 6h14v2H7v-2zm0 6h14v2H7v-2zM4 4h1v2H4V4zm0 6h1v2H4v-2zm0 6h1v2H4v-2z" />
                                    </svg>
                                </button>
                            ...
                            <div class="flex items-center">
                                <select onchange="formatHeading(this.value)"
                                    class="text-sm min-w-[100px] border border-gray-300 rounded-md px-3 py-1.5 sm:py-1.5 bg-white font-medium focus:outline-none focus:ring-1 focus:ring-yellow-400 focus:border-yellow-400">
                ...
                <div class="flex justify-end pt-6">
                    <div class="flex items-center space-x-3 w-full sm:w-auto">
                        <x-bladewind::button can_submit="true" color="yellow" icon="save"
                            class="shadow-md hover:shadow-lg transition-shadow duration-200 w-full sm:w-auto justify-center">
                            Simpan Notulensi
                        </x-bladewind::button>
                    </div>
                </div>
