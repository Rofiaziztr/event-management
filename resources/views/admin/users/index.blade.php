            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">
                                {{ App\Models\User::distinct('division')->whereNotNull('division')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 text-white shadow-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-orange-100 text-sm">Bulan Ini</p>
                            <p class="text-2xl font-bold">
                                {{ App\Models\User::where('created_at', '>=', now()->startOfMonth())->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden flex flex-col relative group" style="transition: all 0.3s ease;">
                            <div class="p-6 flex-grow z-10">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900 truncate max-w-[180px] group-hover:text-indigo-600"
                ...
                @empty
                    <div class="md:col-span-2 lg:col-span-3 text-center py-12">
                        <x-bladewind::empty-state message="Tidak ada pengguna yang ditemukan."
                            button_label="Tambah Pengguna Baru"
                            button_action="window.location.href='{{ route('admin.users.create') }}'" />
                    </div>
                @endforelse
            </div>
