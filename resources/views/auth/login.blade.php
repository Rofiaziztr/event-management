    ...
    <form method="POST" 
            ...
            <div class="relative" x-data="{ showPassword: false }">
                ...
                <button type="button" 
                    ...
                    <svg x-show="showPassword" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display: none;">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.637 6.637m3.241 3.241l4.242 4.242M12 3c.338 0 .674.018 1.006.053M17.975 15.975A9.96 9.96 0 0121.544 12c-1.275-4.057-5.065-7-9.544-7"></path>
                    </svg>
                </button>
            </div>
        ...
        <div class="flex items-center justify-between" x-data="slideIn('up', 300)" class="stagger-4">
            <label for="remember_me" class="flex items-center group cursor-pointer">
                ...
                <span class="ml-2 text-sm text-gray-700 group-hover:text-gray-900 transition-colors duration-200">Ingat saya</span>
            </label>
